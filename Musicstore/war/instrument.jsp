...
<%@ page import="static com.musicstore.database.Ofyservice.*, com.musicstore.entity.User,com.musicstore.entity.Instrument,java.io.*,javax.servlet.*,java.util.*" %>
...
<button class="w3-button w3-ripple w3-yellow"  onclick="window.location.href='/logout'" style="margin-right:5px">Logout</button>
    ...
    <div class="container">
 <h1 style="color:orange;"><b>Instrument</b></h1>
  <table class="table table-bordered">
    <thead>
      <tr>
      <th style="color:orange;">Name(ID)</th>
        <th style="color:orange;">Type</th>
        
        <th style="color:orange;">Photo Id</th>
    ...
    <tbody><%
          ...
          List<Instrument> it1=ofy().load().type(Instrument.class).list();
				
				Iterator<Instrument> Fetch1= it1.iterator();
				while(Fetch1.hasNext())
				{
					Instrument itd1=Fetch1.next();
