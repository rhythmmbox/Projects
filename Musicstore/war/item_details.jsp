...
<%@ page import="static com.musicstore.database.Ofyservice.*, com.musicstore.entity.User,com.musicstore.entity.Item,java.io.*,javax.servlet.*,java.util.*" %>
...
<button class="w3-button w3-ripple w3-yellow"  onclick="window.location.href='/logout'" style="margin-right:5px">Logout</button>
    ...
    <div class="container">
 <h1 style="color:green;"><b>Item</b></h1>
  <table class="table table-bordered">
    <thead>
      <tr>
      <th style="color:green;">Name(ID)</th>
        <th style="color:green;">Photo Id</th>
        
        <th style="color:green;">Item Quantity</th>
        <th style="color:green;">Item Type</th>
        <th style="color:green;">Company</th>
        <th style="color:green;">Model No</th>
    ...
    <tbody><%
          ...
          List<Item> i1=ofy().load().type(Item.class).list();
				...
				{
					Item id1=Fetch1.next();
					
				%>
      <tr>
              <td><%=id1.getName()%></td>
      
        <td><%=id1.getPhotoId()%></td>
        <td><%=id1.getItem_Quant()%></td>
                <td><%=id1.getItem_Type()%></td>
                <td><%=id1.getCompany()%></td>
                <td><%=id1.getModel_No()%></td>
               <td><%=id1.getPrice()%></td>
