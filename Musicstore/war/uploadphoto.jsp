...
%>
	<form action="<%= blobstoreService.createUploadUrl("/uploadphoto") %>" method="post" enctype="multipart/form-data">
    Select image to upload:
<input type="file" size="20" accept="IMAGE.*" value="Upload Image" name="myFile" required multiple="multiple"> 
     <input type="hidden" name="loc" value="<%=loc%>">
          <input type="hidden" name="price" value="<%=price%>">
          <input type="hidden" name="quantity" value="<%=quant%>">
          <input type="hidden" name="model_no" value="<%=model_no%>">
                    <input type="hidden" name="company_name" value="<%=comp_name%>">
                    <input type="hidden" name="inst_type" value="<%=inst_type%>">
